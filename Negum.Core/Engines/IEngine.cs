...
namespace Negum.Core.Engines
{
    ...
    /// https://github.com/TheNegumProject/Negum.Core
    /// </author>
    public partial class EngineInstance : IEngine
    {
        public string Path { get; internal set; }
        public IData Data { get; internal set; }
        public IEnumerable<IFont> Fonts { get; internal set; }
        public IEnumerable<ISound> Sounds { get; internal set; }
        public IEnumerable<IStage> Stages { get; internal set; }
        public IEnumerable<ICharacter> Characters { get; internal set; }
    }
}