...
namespace Negum.Core.Managers
{
    ...
    /// </author>
    public interface INegumNegumManager : INegumManager
    {
        INegumNegumOptions Options => this.GetSection<INegumNegumOptions>("Options");
        INegumNegumRules Rules => this.GetSection<INegumNegumRules>("Rules");
        INegumNegumConfig Config => this.GetSection<INegumNegumConfig>("Config");
        INegumNegumDebug Debug => this.GetSection<INegumNegumDebug>("Debug");
        INegumNegumVideo Video => this.GetSection<INegumNegumVideo>("Video");
        INegumNegumSound Sound => this.GetSection<INegumNegumSound>("Sound");
        INegumNegumMisc Misc => this.GetSection<INegumNegumMisc>("Misc");
        INegumNegumArcade Arcade => this.GetSection<INegumNegumArcade>("Arcade");
        INegumNegumInput Input => this.GetSection<INegumNegumInput>("Input");
        INegumNegumKeys P1Keys => this.GetSection<INegumNegumKeys>("P1 Keys");
        INegumNegumKeys P2Keys => this.GetSection<INegumNegumKeys>("P2 Keys");
        INegumNegumKeys P1Joystick => this.GetSection<INegumNegumKeys>("P1 Joystick");
        INegumNegumKeys P2Joystick => this.GetSection<INegumNegumKeys>("P2 Joystick");
    }

    public interface INegumNegumOptions : INegumManagerSection
    {
    ...
    public interface INegumNegumRules : INegumManagerSection
    {
        /// <summary>
    ...
    public interface INegumNegumConfig : INegumManagerSection
    {
        /// <summary>
    ...
    public interface INegumNegumDebug : INegumManagerSection
    {
        /// <summary>
    ...
    public interface INegumNegumVideo : INegumManagerSection
    {
        /// <summary>
    ...
    public interface INegumNegumSound : INegumManagerSection
    {
        /// <summary>
    ...
    public interface INegumNegumMisc : INegumManagerSection
    {
        /// <summary>
    ...
    public interface INegumNegumArcade : INegumManagerSection
    {
        /// <summary>
    ...
    public interface INegumNegumInput : INegumManagerSection
    {
    ...
    public interface INegumNegumKeys : INegumManagerSection
    {
