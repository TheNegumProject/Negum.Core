...
namespace Negum.Core.Managers
{
    ...
    /// </author>
    public interface ICharacterCommandsManager : IConfigurationManager
    {
    ...
    public interface ICharacterCommandsRemap : IConfigurationManagerSection
    {
    ...
    public interface ICharacterCommandsDefaults : IConfigurationManagerSection
    {
        /// <summary>
    ...
    public interface ICharacterCommandsCommand : IConfigurationManagerSection
    {
        /// <summary>
    ...
    public interface ICharacterCommandsCommandStatedef : IConfigurationManagerSection
    {
    }

    public interface ICharacterCommandsState : IConfigurationManagerSection
    {
