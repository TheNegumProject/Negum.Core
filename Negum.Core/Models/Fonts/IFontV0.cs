...
namespace Negum.Core.Models.Fonts
{
    ...
    public class FontV0 : Font, IFontV0
    {
        ...
        public uint SpriteDataOffset { get; internal set; }
        public int SpriteDataLength { get; internal set; }
        public uint TextDataOffset { get; internal set; }
        public int TextDataLength { get; internal set; }
